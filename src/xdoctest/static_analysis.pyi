...
from xdoctest.utils.util_import import (
    is_modname_importable as is_modname_importable,
    modname_to_modpath as modname_to_modpath,
    modpath_to_modname as modpath_to_modname,
...
def parse_static_calldefs(
    source: str | None = None, fpath: str | None = None
) -> Dict[str, CallDefNode]: ...
def parse_calldefs(
    source: Incomplete | None = ..., fpath: Incomplete | None = ...
): ...
...
def is_balanced_statement(
    lines: List[str], only_tokens: bool = ..., reraise: int = ...
) -> bool: ...
def extract_comments(source: str | List[str]) -> Generator[Any, None, Any]: ...
def six_axt_parse(
    source_block, filename: str = '<source_block>', compatible: bool = True
