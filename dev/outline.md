...
### Quick aside on formal languages - 2 minutes
   ...
   *shows an image of the simple 4-level hierarchy with an image Noam Chomsky and of Alan Turing (next to recursively enumerable languages), the left shows the richer version with 14 levels*
...
### Formal Python - 2 minutes
   ...
   * Stress the point that doctests are Python code the p
